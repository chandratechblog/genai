...
prompt_template = ChatPromptTemplate.from_template(
    ...
    Please answer the questions based on the provided context only, please decline to answer if the question is not related to the context provided, and please do not suggest any questions and answers. If you are unsure about the answer, please ask for the information from the user. Please don't rename or change the product name even though the user asked for it.
